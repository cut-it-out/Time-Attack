...
namespace TimeAttack
{
    ...
    public class ShooterSettingsSO : ScriptableObject
    {
        ...
        [SerializeField] float moveTowardDirectionY = -4f;
        [SerializeField] float moveTowardDirectionX = -8f;
        ...
        { 
            ...
            { 
                return new Vector3(
                    Random.Range(-1 * Mathf.Abs(moveTowardDirectionX), Mathf.Abs(moveTowardDirectionX)), 
                    moveTowardDirectionY, 
                    0f); 
            } 
        } 
